            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <form action="{{ route('tasks.update', $task->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('name') border-red-500 @enderror" value="{{ old('name', $task->name) }}" required>
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="due_date" id="due_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('due_date') border-red-500 @enderror" value="{{ old('due_date', $task->due_date) }}">
                        @error('due_date')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        @if($task->image)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $task->image) }}" alt="Task Image" class="object-contain rounded border mb-2">
                            </div>
                        @endif
                    ...
                    <div class="mb-6 flex items-center">
                        <input type="checkbox" name="is_completed" id="is_completed" value="1" class="mr-2 leading-tight" {{ old('is_completed', $task->is_completed) ? 'checked' : '' }}>
