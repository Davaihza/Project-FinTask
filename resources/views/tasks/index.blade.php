    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-8 main-content overflow-y-auto">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('tasks.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md">
                    Add New Task
                </a>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow overflow-x-auto">
                @if ($tasks->isEmpty())
                    <p class="text-gray-700">No tasks found. Click "Add New Task" to create one.</p>
                @else
                        ...
                        <tbody>
                            @foreach ($tasks as $task)
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">{{ $task->description ?? 'N/A' }}</p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
